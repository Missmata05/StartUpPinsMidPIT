...
! function() {
    ...
    window.hjBootstrap = window.hjBootstrap || function(t, e, r) {
        ...
        d.async = 1, d.src = hj.scriptDomain + e, d.charset = "utf-8", l.appendChild(d), c.revision = "98bf68d", window.hjBootstrap = c
    }, window.hjLazyModules = window.hjLazyModules || {
        SURVEY_V2: {
            js: "survey-v2.d837311e92d8b0333fd2.js"
        },
        SURVEY_BOOTSTRAPPER: {
            js: "survey-bootstrapper.46fe462635638688d5c0.js"
        },
        SURVEY_ISOLATED: {
            js: "survey-isolated.a0d0aa5250de21f15b26.js"
        },
        HEATMAP_RETAKER: {
            js: "heatmap-retaker.f79c0c7bb13d8a14bddc.js"
        },
        SURVEY_INVITATION: {
            js: "survey-invitation.08638069a556eb586134.js"
        },
        NOTIFICATION: {
            js: "notification.86732657079a99e6ce8a.js"
        },
        PREACT_INCOMING_FEEDBACK: {
            js: "preact-incoming-feedback.c3f214ce22a949ed0d59.js"
        },
        SENTRY: {
    ...
    }, m ? window._uxa.push(["start:hotjar", window.hjSiteSettings]) : (window.hjBootstrap("https://script.hotjar.com/", "modules.1bb7849d5667ca754312.js", "783122"), hj.metrics.timeEnd("resource-blocking-time", {
        tag: {
            resource: "hotjar-js"
        },
        start: w,
