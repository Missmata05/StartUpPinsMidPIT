...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "vtp_conversionId": "992156880",
                "vtp_conversionLabel": "10O0CJSutHMQ0LmM2QM",
                "vtp_url": ["macro", 3],
                ...
                "function": "__html",
                "once_per_event": true,
                "vtp_html": "\u003Cscript type=\"application\/ld+json\"\u003E\n{\n  \"@context\": \"http:\/\/schema.org\",\n  \"@type\": \"EducationalOrganization\",\n  \"name\": \"Startup Institute\",\n  \"url\": \"https:\/\/www.startupinstitute.com\/\",\n  \"logo\": \"https:\/\/i.imgur.com\/kwU71jY.png\",\n  \"contactPoint\": {\n    \"@type\": \"ContactPoint\",\n    \"telephone\": \"+1-888-425-5557\",\n    \"contactType\": \"customer service\",\n    \"contactOption\": \"TollFree\",\n    \"areaServed\": \"US\",\n    \"availableLanguage\": \"English\"\n  },\n  \"sameAs\": [\n    \"https:\/\/www.facebook.com\/StartupInst\/\",\n    \"https:\/\/twitter.com\/StartupInst\",\n    \"https:\/\/www.youtube.com\/channel\/UCpHN5Ye4AD3-TR6bZZqAgpg\",\n    \"https:\/\/www.linkedin.com\/company\/startup-institute\"\n  ]\n}\n\u003C\/script\u003E",
    ...
    */
    ...
    var Gh = function(a) {
        ...
        Qh = /^[0-9A-Fa-f]{64}$/,
        Uh = {},
        Vh = (Uh.email = "em", Uh.phone_number = "pn", Uh.first_name = "fn",
            Uh.last_name = "ln", Uh.street = "sa", Uh.city = "ct", Uh.region = "rg", Uh.country = "co", Uh.postal_code = "pc", Uh.error_code = "ec", Uh),
        Wh = {},
        Xh = (Wh.email = "sha256_email_address", Wh.phone_number = "sha256_phone_number", Wh.first_name = "sha256_first_name", Wh.last_name = "sha256_last_name", Wh.street = "sha256_street", Wh),
        Zh = function(a, b) {
            a.some(function(c) {
        ...
        bi = function(a) {
            for (var b = ["tv.1"], c = 0, d = 0; d < a.length; ++d) {
                var e = a[d].name,
                    ...
                    g = a[d].index,
                    h = Vh[e];
                h && f && (-1 === Yh.indexOf(e) || /^e\d+$/.test(f) || Th.test(f) || Qh.test(f)) && (void 0 !== g && (h += g), b.push(h + "." + f), c++)
            }
    ...
    ui.je = Number("0") || 0;
    ui.Ta = "dataLayer";
    ui.Dm = "ChAI8MP4sAYQ18yy47LZg+k9EiQAtW4W+oBvQbrL3mmDfDTK43M+XdOUleOuRZCPR3fd1Lrw82MaAiZ0";
    var wi = {
            __cl: 1,
            __ecl: 1,
            __ehl: 1,
    ...
    var mj;
    try {
        mj = JSON.parse(gb("eyIwIjoiUlUiLCIxIjoiIiwiMiI6ZmFsc2UsIjMiOiJnb29nbGUucnUiLCI0IjoiIiwiNSI6dHJ1ZSwiNiI6ZmFsc2UsIjciOiJhZF9zdG9yYWdlfGFuYWx5dGljc19zdG9yYWdlfGFkX3VzZXJfZGF0YXxhZF9wZXJzb25hbGl6YXRpb24ifQ"))
    } catch (a) {
        M(123), lj(2), mj = {}
    }
    var nj = function() {
    ...
    var Nq = function(a) {
            if (a.eventName === Q.g.ba && "page_view" === a.metadata.hit_type)
                if (T(17)) {
                    ...
                    a.m[Q.g.Yc] = Q.g.Nb;
                    if (a.metadata.consent_updated) a.m[Q.g.Yc] = Q.g.Tj,
                        a.m[Q.g.ic] = "1";
                    else {
                        var m = Cp();
                        a.m[Q.g.Ed] = m.gclid;
                        a.m[Q.g.Ld] = m.dclid;
                        a.m[Q.g.ii] = m.gclsrc;
                        a.m[Q.g.Ed] || a.m[Q.g.Ld] || (a.m[Q.g.Re] = m.wbraid, a.m[Q.g.cg] = m.gbraid);
        ...
        Mq = function(a) {
            var b = a.vd,
                c = a.Bd,
                d = a.ac;
            a.pd && (Jo(b[Q.g.Tb], !!b[Q.g.W]) && (Gp(Pq, d), Hp(d), Vo(d)), Ep(d), Lp(Pq, d), Mp(d));
            b[Q.g.W] && (Jp(Pq, b[Q.g.W], b[Q.g.qb], !!b[Q.g.Wa], d.prefix), Kp(b[Q.g.W], b[Q.g.qb], !!b[Q.g.Wa], d.prefix), Wo(No(d.prefix), b[Q.g.W], b[Q.g.qb], !!b[Q.g.Wa], d), Wo("FPAU", b[Q.g.W], b[Q.g.qb], !!b[Q.g.Wa], d));
            c && Op(Qq);
            Qp(Qq)
        },
        Rq = function(a, b, c, d) {
        ...
        ar = function(a) {
            xl(function() {
                function b(w) {
                    ...
                    A = vi.reported_gclid;
                    var E = T(41) ? (y ? B : "") + "." + (W(Q.g.M) ? 1 : 0) + "." + (W(Q.g.O) ? 1 : 0) : h && W(Q.g.M) ? n + "." + B + (w ? "gcu" : "gcs") : n + (w ? "gcu" : "gcs");
                    if (!A[E]) {
                        A[E] = !0;
                        var F = {},
                            C = function(P, S) {
                        ...
                        if (!(F.hasOwnProperty("gclid") || F.hasOwnProperty("dclid") || F.hasOwnProperty("gclaw")) && (C("gbraid",
                                Zq(d, r)), !F.hasOwnProperty("gbraid") && hl() && x)) {
                            var O = pp(B + "_gb");
                            0 < O.length && C("gclgb", O.join("."))
                        }
                        C("gtm", Ln(f.eventMetadata.source_canonical_id, !e));
                        h && W(Q.g.M) && (Ro(g || {}), y && C("auid", Lo[No(g.prefix)] || ""));
                        $q || a.qj && C("did", a.qj);
                        a.gh && C("gdid", a.gh);
                        a.Zg && C("edid", a.Zg);
    ...
    var kt, lt = function() {
        ...
        ot = function(a, b) {
            a && (b.m[Q.g.kf] = a.architecture, b.m[Q.g.lf] = a.bitness, a.fullVersionList && (b.m[Q.g.nf] = a.fullVersionList.map(function(c) {
                    return encodeURIComponent(c.brand || "") + ";" + encodeURIComponent(c.version || "")
                }).join("|")),
                b.m[Q.g.pf] = a.mobile ? "1" : "0", b.m[Q.g.qf] = a.model, b.m[Q.g.rf] = a.platform, b.m[Q.g.tf] = a.platformVersion, b.m[Q.g.uf] = a.wow64 ? "1" : "0")
        };
    ...
    var wt = function() {
        ...
        Dt = function(a) {
            if (Bt(a, ["conversion", "remarketing", "user_data_lead", "user_data_web"])) {
                var b = a.m[Q.g.kb],
                    c = !0 === V(a.o, Q.g.Ue);
                ...
                Bt(a, ["conversion", "remarketing"]) && (a.m[Q.g.Ri] = a.metadata.is_gcp_conversion ? "www.google.com" : "www.googleadservices.com")
            }
        },
        Et = function(a) {
        ...
        Ft = function(a) {
            if (!a.metadata.consent_updated && Bt(a, ["conversion", "remarketing"])) {
                ...
                for (var e, f = D, g = f; f && f != f.parent;) f = f.parent, Hm(f) && (g = f);
                e = g;
                var h;
        ...
        Gt = function(a) {
            Bt(a, ["conversion", "remarketing"]) && (a.copyToHitData(Q.g.za), a.copyToHitData(Q.g.ma), a.copyToHitData(Q.g.ya),
        ...
        Kt = function(a) {
            !Bt(a, ["conversion"]) || T(41) && !W(Q.g.O) || (!0 === D._gtmpcm || ur() ? a.m[Q.g.Pb] = "2" : T(26) && (It || qt(pt()) || (Jm(''), It = !0), Jt || (Jt = !0, Jm('\x3d\x3d')), qt(pt()) && (a.m[Q.g.Pb] = "1")))
        },
        Lt = function(a) {
                        ...
                        if (!1 !== V(a.o, Q.g.Aa) || b(2))
                            if (yn(a.o) || b(3))
                                if (!1 !== V(a.o, Q.g.Ob) || b(4)) {
                                    var c;
                                    T(25) ? c = a.eventName === Q.g.ba ? V(a.o, Q.g.Ia) : void 0 : c = V(a.o, Q.g.Ia);
                                    if (!1 !== c || b(5))
                                        if (st() || b(6)) T(24) && kb() ? (a.m[Q.g.xi] = jb("fdr"), delete hb.fdr) : (a.m[Q.g.jg] = "1", a.metadata.send_fledge_experiment = !0)
                                }
            }
        },
        Mt = function(a) {
            ...
            a.metadata.redact_ads_data = null != V(a.o, Q.g.fa) && !1 !==
                V(a.o, Q.g.fa);
        ...
        Nt = function(a) {
            if (oq(a, "ccd_add_1p_data", !1) && W(wt())) {
                ...
                if (bj(b)) {
                    var c = V(a.o, Q.g.Ca);
                    null === c ? a.metadata.user_data_from_code = null : (b.enable_code && Va(c) && (a.metadata.user_data_from_code = c), Va(b.selectors) && (a.metadata.user_data_from_manual = aj(b.selectors)))
                }
            }
        },
        Ot = function(a) {
            var b = !a.metadata.send_user_data_hit && Bt(a, ["conversion", "user_data_web"]),
        ...
        Pt = function(a) {
            Bt(a, ["conversion", "remarketing"]) && (a.o.isGtmEvent ? "conversion" !== a.metadata.hit_type && a.eventName && (a.m[Q.g.Yc] = a.eventName) : a.m[Q.g.Yc] = a.eventName, z(a.o.m, function(b, c) {
                ri[b.split(".")[0]] || (a.m[b] =
                    c)
            }))
        },
        Qt = function(a) {
            if (a.eventName === Q.g.ba && !a.metadata.consent_updated && (a.metadata.is_config_command = !0, Bt(a, "conversion") && (a.metadata.speculative = !0), !Bt(a, "remarketing") || !1 !== V(a.o, Q.g.Ob) && !1 !== V(a.o, Q.g.Ia) || (a.metadata.speculative = !0), Bt(a, "landing_page"))) {
                var b = V(a.o, Q.g.sa) || {},
                    c = V(a.o, Q.g.Sa),
        ...
        Rt = function(a) {
            if (!oq(a, "hasPreAutoPiiCcdRule", !1) && Bt(a, "conversion") && W(Q.g.M)) {
            ...
            if (a.eventName === Q.g.Oa && !a.o.isGtmEvent) {
                if (!a.metadata.consent_updated && Bt(a, "conversion")) {
                    ...
                    var c = String(V(a.o, Q.g.ob)),
                        d = a.m[c],
                        e = V(a.o, c);
                    c === Q.g.Pa || c === Q.g.Cb ? Rq({
                        Lj: c,
                        callback: b,
                        xj: e
                    }, a.metadata.cookie_options, a.metadata.redact_ads_data, gq) : b(d ||
                        e)
                }
                a.isAborted = !0
            }
        ...
        function(a) {
            if (Bt(a, ["conversion", "remarketing"])) {
                ...
                b && a.eventName !== Q.g.Ha || (a.copyToHitData(Q.g.da), b && (a.copyToHitData(Q.g.Jd), a.copyToHitData(Q.g.Hd), a.copyToHitData(Q.g.Id), a.copyToHitData(Q.g.Gd), a.m[Q.g.dg] = a.eventName))
            }
        },
        Wt = function(a) {
            if (Bt(a, ["conversion", "remarketing", "user_data_lead", "user_data_web"])) {
                ...
                yn(b) ? a.m[Q.g.Jb] = !1 : (a.m[Q.g.Jb] = !0, Bt(a, "remarketing") &&
                    (a.isAborted = !0))
            }
        },
        Xt = function(a) {
            Bt(a, "conversion") && (a.copyToHitData(Q.g.dd), a.copyToHitData(Q.g.Kd), a.copyToHitData(Q.g.jd), a.copyToHitData(Q.g.Qd), a.copyToHitData(Q.g.sc), a.copyToHitData(Q.g.Wc))
        },
        Yt = function(a) {
            qr(a);
        },
        ...
        bu = function(a) {
            Bt(a, ["conversion"]) && (a.metadata.redact_click_ids = !!a.metadata.redact_ads_data && !W(wt()))
        },
        cu = function(a) {
            if (Bt(a, ["conversion", "user_data_lead", "user_data_web"]) && W(Q.g.M) && a.metadata.conversion_linker_enabled) {
        ...
        du = function(a) {
            if (Bt(a, ["conversion", "remarketing", "user_data_lead", "user_data_web"]) && a.metadata.conversion_linker_enabled && W(Q.g.M)) {
                var b = !T(3);
        ...
        hu = function(a) {
            Bt(a, ["conversion"]) && a.o.eventMetadata.is_external_event && (a.m[Q.g.Si] = !0)
        },
        iu = function(a) {
        ...
        ku = function(a) {
            T(17) && a.eventName === Q.g.ba && Bt(a, "page_view") && !a.metadata.consent_updated && !a.o.isGtmEvent ? nr(a.target, a.o) : Bt(a, "call_conversion") && (nr(a.target, a.o), a.isAborted = !0)
        },
        It = !1,
        Jt = !1;
    var mu = function(a, b) {
            ...
            z(a.m, function(f, g) {
                var h = lu[f];
                h && void 0 !== g && "" !== g && (!a.metadata.redact_click_ids || f !== Q.g.Ed && f !== Q.g.Ld && f !== Q.g.Re && f !== Q.g.cg || (g = "0"), d(h, g))
            });
        ...
        ou = {},
        lu = (ou[Q.g.ic] = "gcu", ou[Q.g.hb] = "gclgb", ou[Q.g.Pa] = "gclaw", ou[Q.g.hi] = "gad_source", ou[Q.g.Ed] = "gclid", ou[Q.g.ii] = "gclsrc",
            ou[Q.g.cg] = "gbraid", ou[Q.g.Re] = "wbraid", ou[Q.g.Cb] = "auid", ou[Q.g.ki] = "rnd", ou[Q.g.oi] = "ncl", ou[Q.g.eg] = "gcldc", ou[Q.g.Ld] = "dclid", ou[Q.g.lb] = "edid", ou[Q.g.Yc] = "en", ou[Q.g.wc] = "gdpr", ou[Q.g.pb] = "gdid", ou[Q.g.Wd] = "frm", ou[Q.g.bd] = "lps", ou[Q.g.Yd] = "did", ou[Q.g.wa] = "dl", ou[Q.g.Ba] = "dr", ou[Q.g.xc] = "gdpr_consent", ou[Q.g.de] = "us_privacy", ou[Q.g.Jb] = "npa", ou);
    var pu = {
        K: {
    ...
    var jv = function(a) {
        ...
        kv = function(a) {
            ...
            var b = a.id;
            T(15) && (null != a.item_id ? b = a.item_id : null ==
                b && (b = a.item_name));
            return b
        },
        ov = function(a) {
            ...
            switch (c) {
                case "conversion":
                    ...
                    a.metadata.is_gcp_conversion && (r = "&gcp=1&ct_cookie_present=1", q({
                        Ea: "" + Kj(e ? "https://googleads.g.doubleclick.net" : g) + "/pagead/viewthroughconversion/" + d + "/?" + sv(a, b) +
                            r,
                        format: n,
                        Ga: !0
                    }));
                ...
                case "remarketing":
                    var u = b.data || "",
                        v = jv(lv(a.m[Q.g.da]));
                    if (v.length) {
                        for (var w = 0; w < v.length; w++) b.data = qv(u, v[w]), q({
                            Ea: "" + Kj("https://googleads.g.doubleclick.net") + "/pagead/viewthroughconversion/" + d + "/?" + sv(a, b),
                            format: n,
                            Ga: !0
                        ...
                        Ea: "" + Kj("https://googleads.g.doubleclick.net") + "/pagead/viewthroughconversion/" +
                            d + "/?" + sv(a, b),
                        format: n,
                        Ga: !0
                    });
                ...
                case "user_data_lead":
                    q({
                        Ea: "" + Kj("https://google.com") + "/pagead/form-data/" + d + "?" + sv(a, b),
                        format: 1,
                        Ga: !0
                    });
                    break;
                case "user_data_web":
                    q({
                        Ea: "" + Kj("https://google.com") + "/ccm/form-data/" + d + "?" + sv(a, b),
                        format: 1,
                        Ga: !0
                    })
            }
            1 < f.length && nb(a.o.onSuccess) && (h = Jb(a.o.onSuccess, p));
            Jn() || "conversion" !== c && "remarketing" !== c || !a.metadata.send_fledge_experiment || (T(23) && "conversion" === c && (b.ct_cookie_present = 0), q({
                Ea: "" + vt() + "/td/rul/" + d + "?" + sv(a, b),
                format: 4,
                Ga: !1
            }));
        ...
        vv = {},
        wv = (vv[Q.g.ic] = "gcu", vv[Q.g.hb] = "gclgb", vv[Q.g.Pa] = "gclaw", vv[Q.g.Cb] = "auid", vv[Q.g.Gd] = "dscnt", vv[Q.g.Hd] = "fcntr", vv[Q.g.Id] = "flng", vv[Q.g.Jd] = "mid", vv[Q.g.dg] = "bttype", vv[Q.g.kb] = "label", vv[Q.g.Pb] = "capi",
            vv[Q.g.Ve] = "pscdl", vv[Q.g.ya] = "currency_code", vv[Q.g.Kd] = "vdltv", vv[Q.g.ri] = "_dbg", vv[Q.g.Qd] = "oedeld", vv[Q.g.lb] = "edid", vv[Q.g.xi] = "fdr", vv[Q.g.jg] = "fledge", vv[Q.g.Ud] = "gac", vv[Q.g.vc] = "gacgb", vv[Q.g.og] = "gacmcov", vv[Q.g.wc] = "gdpr", vv[Q.g.pb] = "gdid", vv[Q.g.sg] = "gsaexp", vv[Q.g.Wd] = "frm", vv[Q.g.Xd] = "gtm_up", vv[Q.g.bd] = "lps", vv[Q.g.Yd] = "did", vv[Q.g.dd] = void 0, vv[Q.g.Fb] = "tiba", vv[Q.g.Ub] = "rdp", vv[Q.g.rb] = "ecsid", vv[Q.g.jd] = "delopc", vv[Q.g.xc] = "gdpr_consent", vv[Q.g.za] = "oid", vv[Q.g.kf] = "uaa", vv[Q.g.lf] =
            "uab", vv[Q.g.nf] = "uafvl", vv[Q.g.pf] = "uamb", vv[Q.g.qf] = "uam", vv[Q.g.rf] = "uap", vv[Q.g.tf] = "uapv", vv[Q.g.uf] = "uaw", vv[Q.g.Dg] = "ec_lat", vv[Q.g.Eg] = "ec_meta", vv[Q.g.Fg] = "ec_m", vv[Q.g.Gg] = "ec_sel", vv[Q.g.Hg] = "ec_s", vv[Q.g.kd] = "ec_mode", vv[Q.g.Na] = "userId", vv[Q.g.de] = "us_privacy", vv[Q.g.ma] = "value", vv[Q.g.Ig] = "mcov", vv[Q.g.Ri] = "hn", vv[Q.g.Si] = "gtm_ee", vv[Q.g.Jb] = "npa", vv[Q.g.Sc] = null, vv[Q.g.Gb] = null, vv[Q.g.Ma] = null, vv[Q.g.da] = null, vv[Q.g.wa] = null, vv[Q.g.Ba] = null, vv[Q.g.hf] = null, vv),
        yv = function(a) {
            "page_view" ===
            a.metadata.hit_type ? nu(a) : xv(a, function(b, c) {
                for (var d = tv(a, b), e = d.onSuccess, f = d.zl, g = {}, h = 0; h < f.length; g = {
                        Ea: void 0,
                        eh: void 0,
                        Ga: void 0,
                        Pg: void 0
                    ...
                    if (c && c.rj) {
                        ...
                        Vs(g.Ea + "&em=" + n.Lf, {
                            userData: n.X
                        }, g.Ga && e ? e : function() {}, function(p) {
                            return function(q) {
                                Zh(c.Ol, function(r) {
                                    var t = bi(r),
                                        u = p.Ea;
                                    q && (u = p.Ea.replace("_is_sw=0", q));
                                    uv(u + "&em=" + encodeURIComponent(t.Lf), p.eh, a, b, p.Ga ? e : void 0, p.Pg)
                                })
                            }
                        }(g))
                    } else uv(g.Ea, g.eh, a, b, g.Ga ?
                        e : void 0, g.Pg)
                }
            })
        },
        xv = function(a, b) {
            ...
            if (("conversion" === c || "user_data_lead" === c || "user_data_web" === c) && a.metadata.user_data)
                if (T(41) && !W(Q.g.O) || T(14) && !W(Q.g.M)) T(41) && (d.ec_mode = void 0);
                else {
                    var y = function() {
                        if ("user_data_web" === c) {
                            var C;
    ...
    var FC = function(a, b, c, d) {
        ...
        GC = function(a, b, c, d) {
                        ...
                        if (!u.metadata.consent_updated || "page_view" === u.metadata.hit_type || W(q)) {
                            ...
                            switch (w.metadata.hit_type) {
                                ...
                                case "call_conversion":
                                    ...
                                    break;
                                default:
                                    v = [Sq, Mt, Ct, Pt, Dt, Et, Ft, Gt, Ut, Vt, Xt, Zt, hu, iu, Wt, eu, Qt, $t, au, cu, Nt, Rt, fu, Tq, St, du, Ht, Yt, Ot, ju, Tt, bu, Lt, Kt, gu]
                            }
            ...
            if (g) {
                ...
                } else b === Q.g.ba && (T(17) ? h.push(FC("page_view", g, b, d)) : h.push(FC("landing_page", g, b, d))), h.push(FC("conversion", g, b, d)), h.push(FC("user_data_lead", g, b, d)), h.push(FC("user_data_web", g, b, d)), h.push(FC("remarketing", g, b, d));
                var q = [Q.g.M];
                T(41) && q.push(Q.g.O);
                xl(function() {
                    f();
                    T(18) && (W([Q.g.xa]) || wl(function(r) {
        ...
        function() {
            function a(b, c, d) {
                ...
                var c = !b.hasOwnProperty("vtp_enableConversionLinker") || !!b.vtp_enableConversionLinker,
                    ...
                    f = {},
                    g =
                    (f[Q.g.ma] = b.vtp_conversionValue || 0, f[Q.g.ya] = b.vtp_currencyCode, f[Q.g.za] = b.vtp_orderId, f[Q.g.Ua] = b.vtp_conversionCookiePrefix, f[Q.g.ra] = c, f[Q.g.Fd] = d, f[Q.g.fa] = jI(Q.g.fa), f[Q.g.ja] = jI("developer_id"), f);
                g[Q.g.Aa] = jI(Q.g.Aa), g[Q.g.la] = jI(Q.g.la), g[Q.g.Ob] = jI(Q.g.Ob), g[Q.g.Ia] = jI(Q.g.Ia);
                ...
                b.vtp_enableShippingData && (g[Q.g.jd] = b.vtp_deliveryPostalCode, g[Q.g.Qd] = b.vtp_estimatedDeliveryDate, g[Q.g.sc] = b.vtp_deliveryCountry, g[Q.g.Wc] = b.vtp_shippingFee);
                ...
                var w = {},
                    x = {
                        eventMetadata: (w.hit_type_override = "conversion", w.is_sw_selected = [T(64), T(62)], w),
                        noGtmEvent: !0,
                        isGtmEvent: !0,
            ...
            function b(d) {
                if (G.body) {
                    var e = d.vtp_gtmOnFailure,
                        ...
                        g = f.uj,
                        h = f.onSuccess;
                    if (d.vtp_useIframe) {} else d.vtp_supportDocumentWrite ? c(g, h, e) : a(G.body, Tc(g), h, e)()
                } else eI(function() {
                    b(d)
                }, 200)
            }
